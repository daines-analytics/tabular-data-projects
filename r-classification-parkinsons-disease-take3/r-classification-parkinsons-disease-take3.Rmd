---
title: "Binary Classification Model for Parkinson's Disease Using R Take 3"
author: "David Lowe"
date: "May 3, 2019"
output: 
  html_document: 
...
rfeResults <- rfe(xy_train[,1:totAttr], xy_train[,totCol], sizes=c(50:250), rfeControl=rfeCTRL)
print(rfeResults)
...
startTimeModule <- proc.time()
set.seed(seedNum)
grid <- expand.grid(mtry=c(2,47,92,137,182))
...
finalModel <- gbm(targetVar~., data=xy_complete, n.trees=300, interaction.depth=3, shrinkage=0.1, n.minobsinnode=10)
print(finalModel)
proc.time()-startTimeModule
```
