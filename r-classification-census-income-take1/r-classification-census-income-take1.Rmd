---
title: "Binary Classification Model for Census Income Using R Take 1"
author: "David Lowe"
date: "August 6, 2018"
output: 
  html_document: 
...
entireDataset <- entireDataset[complete.cases(entireDataset), ]
dim(entireDataset)

testDataset <- testDataset[complete.cases(testDataset), ]
dim(testDataset)
