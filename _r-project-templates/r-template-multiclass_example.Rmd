---
title: "Multi-Class Classification Model for [Project Name] Using R version 09"
author: "David Lowe"
date: "April 19, 2019"
output: 
  html_document: 
...
ANALYSIS: [Sample Paragraph - The baseline performance of the machine learning algorithms achieved an average accuracy of 70.16%. Two algorithms (Random Forest and eXtreme Gradient Boosting) achieved the top accuracy metrics after the first round of modeling. After a series of tuning trials, Random Forest turned in the top overall result and achieved an accuracy metric of 78.09%. By using the optimized parameters, the Random Forest algorithm processed the testing dataset with an accuracy of 78.69%, which was even better than the best prediction with the training data.]
