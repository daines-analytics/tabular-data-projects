---
title: "Multi-Class Classification Model for [Project Name] Using R version 07"
author: "David Lowe"
date: "January 4, 2019"
output: 
  html_document: 
...
ANALYSIS: [Sample Paragraph - The baseline performance of the machine learning algorithms achieved an average accuracy of 70.00%. Two algorithms (Random Forest and Stochastic Gradient Boosting) achieved the top accuracy metrics after the first round of modeling. After a series of tuning trials, Random Forest turned in the top overall result and achieved an accuracy metric of 78.04%. By using the optimized parameters, the Random Forest algorithm processed the testing dataset with an accuracy of 78.69%, which was even better than the best prediction with the training data.]
...
finalModel <- randomForest(targetVar~., xy_complete, mtry=4, na.action=na.omit)
summary(finalModel)
proc.time()-startTimeModule
```
