---
title: "Regression Model for Superconductivity Temperature Using R Take 1"
author: "David Lowe"
date: "July 12, 2019"
output: 
  html_document: 
...
ANALYSIS: The baseline performance of the machine learning algorithms achieved an average RMSE of 16.32. Two algorithms (Random Forest and Gradient Boosting) achieved the top RMSE metrics after the first round of modeling. After a series of tuning trials, Random Forest turned in the best overall result and achieved an RMSE metric of 9.69. By using the optimized parameters, the Random Forest algorithm processed the test dataset with an RMSE of 9.39, which was even better than the prediction from the training data.
...
startTimeModule <- proc.time()
set.seed(seedNum)
grid <- expand.grid(mtry = c(2,22,42,62,81))
