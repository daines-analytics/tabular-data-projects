---
title: "Regression Model for Ames Iowa Housing Prices Using R Take 2"
author: "David Lowe"
date: "July 3, 2019"
output: 
  html_document: 
...
startTimeModule <- proc.time()
set.seed(seedNum)
grid <- expand.grid(mtry = c(2,18,33,48,64))
...
# finalModel <- gbm(targetVar~., xy_complete, n.trees = 250, interaction.depth = 3, shrinkage = 0.1, n.minobsinnode = 10, verbose = FALSE)
# summary(finalModel)
proc.time()-startTimeModule
```
