---
title: "Binary Classification Model for German Credit Risks Using R Take 1"
author: "David Lowe"
...
```{r POST_TUNING}
results <- resamples(list(LogReg=fit.final1, RF=fit.final2, GBM=fit.final3))
summary(results)
dotplot(results)
```
...
set.seed(seedNum)
library(gbm)
finalModel <- gbm(targetVar~., data=entireDataset, n.trees=200, shrinkage=0.1, interaction.depth=2, n.minobsinnode=7)
print(finalModel)
proc.time()-startTimeModule
```
