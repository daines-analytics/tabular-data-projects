---
title: "Binary Classification Model for MiniBooNE Particle Identification Using R Take 3"
author: "David Lowe"
...
startTimeModule <- proc.time()
set.seed(seedNum)
grid <- expand.grid(.n.trees=c(250,400,550,700), .shrinkage=0.1, .interaction.depth=3, .n.minobsinnode=10)
...
startTimeModule <- proc.time()
set.seed(seedNum)
grid <- expand.grid(mtry=c(1,8,15,25))
