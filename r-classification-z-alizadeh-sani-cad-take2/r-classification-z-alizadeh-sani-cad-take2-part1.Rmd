---
title: "Binary Classification Model for Coronary Artery Disease Using R Take 2 Part 1"
author: "David Lowe"
date: "June 12, 2019"
output: 
  html_document: 
...
For this portion of the modeling effort, we will focus on the LAD artery.

ANALYSIS: The baseline performance of the machine learning algorithms achieved an average accuracy of 74.41%. Two algorithms (Random Forest and Gradient Boosting) achieved the top accuracy metrics after the first round of modeling. After a series of tuning trials, Random Forest turned in the top overall result and achieved an accuracy metric of 78.45%. By using the optimized parameters, the Random Forest algorithm processed the testing dataset with an accuracy of 77.78%, which was slightly below the prediction accuracy gained from the training data.
