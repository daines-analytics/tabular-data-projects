---
title: "Binary Classification Model for Census Income Using R Take 3"
author: "David Lowe"
date: "August 10, 2018"
output: 
  html_document: 
...
```{r}
entireDataset$native_country <- NULL
testDataset$native_country <- NULL
```
