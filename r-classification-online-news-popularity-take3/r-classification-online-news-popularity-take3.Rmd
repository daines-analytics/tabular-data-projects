...
From the model-building activities, the number of attributes went from 58 down to 42 after eliminating 16 attributes. The processing time went from 6 hours 31 minutes in iteration Take1 down to XX hours YY minutes in iteration Take3, which was a reduction of ZZ% from Take1. It also was a noticeable reduction in comparison to Take2, which reduced the processing time down to 3 hours 18 minutes.
